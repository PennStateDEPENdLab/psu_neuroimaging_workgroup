...
# define where you have put this directory on your computer
# if you set this as an environment variable, the script will not override it here
[ -z "$PESTICA_DIR" ] && PESTICA_DIR=/Users/mnh5174/Data_Analysis/psu_neuroimaging_workgroup/pestica4
