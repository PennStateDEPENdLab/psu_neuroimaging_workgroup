...
physio.log_files.cardiac = {'Physio_20180418_155230_eb3b2e7c-15f6-4aa2-b0af-fd47f2843edd_PULS.log'};
physio.log_files.respiration = {'Physio_20180418_155230_eb3b2e7c-15f6-4aa2-b0af-fd47f2843edd_RESP.log'};
physio.log_files.scan_timing = {'Physio_20180418_155230_eb3b2e7c-15f6-4aa2-b0af-fd47f2843edd_Info.log'};
physio.log_files.relative_start_acquisition = 0;
physio.log_files.align_scan = 'last';
physio.scan_timing.sqpar.Nslices = 60;
physio.scan_timing.sqpar.TR = 0.90;
physio.scan_timing.sqpar.Ndummies = 0;
physio.scan_timing.sqpar.Nscans = 470;
